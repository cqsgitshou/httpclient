package com.hqblicai.http.httpclient;
...
import com.hqblicai.http.RpcHttpBase;
import com.hqblicai.http.RpcHttpException;

public class HttpRequestSimple extends RpcHttpBase{

	private Logger logger=Logger.getLogger(HttpRequestSimple.class);
	...
	public static void main(String[] args) {
		...
		String paramStr= "1122333";
		String result = httpClient.postSendHttp("http://localhost:8080/index.html",paramStr);
	...
	public Object postSendHttp(String url, Object inputObj) {
		...
		try {
			...
			logger.info("请求[" + url + "] " + resp.getStatusLine());
